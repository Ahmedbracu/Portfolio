...
export function BootSequence({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    ...
    >
      <motion.div
        animate={isGlitching ? {
          x: [0, -15, 15, -10, 10, -25, 25, 0],
          y: [0, 8, -8, 15, -15, 20, -20, 0],
          scale: [1, 1.05, 0.95, 1.1, 0.9, 1],
          filter: [
            "hue-rotate(0deg) contrast(1)",
            "hue-rotate(90deg) contrast(1.5) invert(0.2)",
            "hue-rotate(-90deg) contrast(2) invert(0.1)",
            "hue-rotate(180deg) contrast(3) invert(0.5)",
            "hue-rotate(0deg) contrast(1)"
          ],
          opacity: [1, 0.8, 1, 0.4, 1, 0.9, 1]
        } : {}}
      ...
      >
        ...
        {isGlitching && (
          <>
            <div className="absolute inset-0 bg-white mix-blend-difference opacity-20" />
            <motion.div 
              animate={{
                top: ["0%", "50%", "20%", "80%", "0%"],
                height: ["10px", "50px", "5px", "100px", "0px"]
              }}
              transition={{ duration: 0.4, repeat: 1 }}
              className="absolute left-0 right-0 bg-black/50 z-50 backdrop-invert"
            />
          </>
        )}
      </motion.div>
